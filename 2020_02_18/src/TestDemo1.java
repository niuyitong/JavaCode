...
class OuterClass {
     ...
     * 实例内部类：
     * 1、如何获取实例内部类的对象呢？
     *     (a) OuterClass outerClass = new OuterClass();
     *         OuterClass.InnerClass innerClass = outerClass.new InnerClass();
     *     (b) OuterClass.InnerClass innerClass = new OuterClass().new InnerClass();
    ...
    class InnerClass {
        ...
        public void test() {
            System.out.println("data1:"+this.data1);//调内部
            System.out.println(OuterClass.size);//调外部静态
            System.out.println("out::data1:"+ OuterClass.this.data1);//访问外部非静态
        }
    }
}
...
class OuterClass2 {
    ...
    static class InnerClass2 {
        ...
        public void test() {
            System.out.println("data1:" + this.outerClass.data1);//通过传参调用外部类非静态
            System.out.println(data1);
            System.out.println("data5:"+data5);
            System.out.println("data5:" + OuterClass2.data5);//直接访问外部类静态属性
        }
    }
